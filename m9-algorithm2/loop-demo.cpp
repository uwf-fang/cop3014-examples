...
void testSubStringSearch() {
    string str1 = "abcde";
  cout << "index of cd in abcde is " << findSubStr(str1, "cd") << endl;
}
...
void   testIsReverse() {
    ...
    if (isReverse(str1, str2))
      cout << "str1 and str2 is reverse to each other!\n";
    else
      cout << "str1 and str2 is not reverse to each other!\n";
}
